...
public class Film {
     ...
     * @param filmId is the film id to be used to identify movie for trailer and reviews
     */

    public Film(int voteCount, long voteAverage, String title, long popularity, String posterUrl,
                String overview, String releaseDate, int filmId){
    ...
    public int getmFilmId() {return mFilmId;}
}
